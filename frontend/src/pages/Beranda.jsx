        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 md:grid-cols-2 md:py-24 lg:px-8">
          ...
          <div>
            ...
            <p className="mt-5 max-w-md text-base leading-relaxed text-ink-100/80">
              SI TERTIB membantu sekolah mencatat waktu keluar-masuk dan alasan
              siswa secara digital, sehingga guru dapat memantau kedisiplinan
              kelas dengan data yang rapi dan transparan.
            </p>
            ...
            <div className="card relative rotate-1 bg-white p-6">
              ...
              <dl className="mt-4 space-y-3 text-sm">
                ...
                <div className="flex justify-between border-b border-dashed border-ink-100 pb-2">
                  ...
                  <dd className="font-medium text-ink-800">X IPA 1</dd>
                </div>
                <div className="flex justify-between border-b border-dashed border-ink-100 pb-2">
                  <dt className="text-ink-400">Alasan</dt>
                  <dd className="font-medium text-ink-800">Ke UKS</dd>
                </div>
                <div className="flex justify-between border-b border-dashed border-ink-100 pb-2">
                  <dt className="text-ink-400">Waktu Keluar</dt>
                  <dd className="font-mono font-medium text-ink-800">09.15</dd>
                </div>
                <div className="flex justify-between">
                  <dt className="text-ink-400">Waktu Masuk</dt>
                  <dd className="font-mono font-medium text-ink-800">09.27</dd>
                </div>
              </dl>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-ink-400">
            Tiga langkah sederhana, dari siswa keluar kelas sampai guru melihat rekapnya.
          </p>
        </div>
          ...
          {[
            {
              no: "01",
              icon: ClipboardList,
              title: "Siswa isi identitas",
              desc: "Saat keluar kelas, siswa mengisi nama, NISN, kelas, dan alasan lewat halaman Isi Identitas.",
            },
            {
              no: "02",
              icon: DoorOpen,
              title: "Waktu tercatat otomatis",
              desc: "Waktu keluar dan waktu masuk terekam otomatis oleh sistem, tidak perlu dicatat manual di buku.",
            },
            {
              no: "03",
              icon: BarChart3,
              title: "Guru pantau rekapnya",
              desc: "Guru login untuk melihat daftar siswa beserta persentase keluar kelas dalam satu hari.",
            },
          ].map((step) => (
            <div key={step.no} className="card p-6">
            ...
            <div>
              ...
              <ul className="mt-6 space-y-4">
                {[
                  ...
                  "Akses data siswa dilindungi login, hanya untuk guru/staf sekolah.",
                ].map((text) => (
